...
const
   header		  = '<!DOCTYPE html><head><title>エアコン制御プログラム</title><meta name="viewport" content="width=640"><style>input[type="radio"]:checked+label{font-weight:bold;}</style></head><body>';
   footer		  = '</body>';
